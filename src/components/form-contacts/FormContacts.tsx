    ...
    return <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
            <label className={styles.formField}>
                Ім'я:
                <input type="text" className={nameError && styles.errorInput} placeholder="Ваше ім'я" {...register("name", {
                    required: {
                        value: true,
            ...
            <label className={styles.formField}>
                Телефон:
                <input type="text" className={phonenumberError && styles.errorInput} placeholder="+ 38 0" {...register("phonenumber", {
                    required: {
                        value: true,
